        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            <p className="text-primary-foreground/90 leading-relaxed">
              Chez devlo, nous transformons votre prospection B2B en pipeline de rendez-vous qualifiés. 
              Notre approche sur mesure combine expertise humaine et technologie pour générer des leads 
              ultra-qualifiés qui se convertissent en clients.
            </p>
          </div>
          <div>
